...
run_check "action pinning" scripts/validate_action_pinning.sh
run_check "action pinning fixtures" scripts/test_action_pinning.sh
run_check "supply-chain evidence fixtures" scripts/test_supply_chain_evidence.sh
run_check "SBOM fixtures" scripts/test_sbom.sh
run_check "release attestation fixtures" scripts/test_release_attestation.sh
run_check "build record fixtures" scripts/test_build_record.sh
run_check "supply-chain release fixtures" scripts/test_supply_chain_release.sh
