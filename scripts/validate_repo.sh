...
required_files=(
  ...
  "bootstrap/templates/policy-standard.json"
  "bootstrap/templates/policy-high-trust.json"
  "bootstrap/templates/document-map.json"
  "bootstrap/templates/document-map.schema.json"
  "bootstrap/templates/CODE_OF_CONDUCT.md"
  "bootstrap/templates/LICENSE"
  "bootstrap/templates/README.md"
  "bootstrap/templates/RELEASE.md"
  "bootstrap/templates/SECURITY.md"
  ...
  "bootstrap/templates/supply-chain-README.md"
  "scripts/ugs_init.py"
  "scripts/ugs_init.sh"
  "scripts/ugs.sh"
