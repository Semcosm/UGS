...
required_files=(
  ...
  ".ugs/schema/cr-attestation.schema.json"
  ...
  "scripts/test_cr_attestation.sh"
  ...
  "bootstrap/templates/cr-attestation.schema.json"
...
grep -Fq "docs/git/ugs-cr-attestation.md" README.md || fail "README must document CR attestation contract"
